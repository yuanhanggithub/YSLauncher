...
public class DigitalClock extends LinearLayout {
    ...
    private final static String M12 = "yyyy-M-d h:mm";
    private final static String M24 = "yyyy-M-d kk:mm";
    ...
    private static class FormatChangeObserver extends ContentObserver {
        private WeakReference<DigitalClock> mClock;
        private Context mContext;
        public FormatChangeObserver(DigitalClock digitalClock2) {
            super(new Handler());
            mClock = new WeakReference<DigitalClock>(digitalClock2);
            mContext = digitalClock2.getContext();
        }
        @Override
